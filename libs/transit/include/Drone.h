...
#include "Weather.h"
#define GLOBAL_WEATHER Weather::GetInstance()
...
class Drone : public IEntity {
 public:
   ...
   * @param spe_ The new speed of the drone
   */
  ...
  /**
   * @brief Sets the publisher of the drone
   * @param pub_ The publisher of the drone
   */
  void SetPublisher(IPublisher* pub_) { toPublisher = pub_; }
  ...
  /**
   * @brief Helper function to update drone's behavior based on the weather
   */
  void UpdateHelper();
 ...
 private:
  ...
  IPublisher* toPublisher = nullptr;
  std::string name = details["name"];
  std::string robotName = "NULL";
};
